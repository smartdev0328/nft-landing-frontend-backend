...
import Egg from 'images/nfts/0Gagamaru.png';
  ...
  const renderContent = () => {
    ...
    return (
      <div className="w-full ">
        <video autoPlay id="vid" muted>
          <source type="video/mp4" src="./gagamaru.mp4"></source>
        </video>
      </div>
    );
  };
  ...
  return (
    <div
      ...
      <div className="relative flex-shrink-0 ">
        <div className="bg-gradient-to-r from-[#E9FFBF] to-[#B8D675] rounded-t-3xl">
          <Link to={'/nft-detail3'}>
            <NcImage
      ...
      <div className="p-4 py-5 space-y-3">
        ...
        <h2 className={`text-xl font-medium`}>Gagamaru</h2>
