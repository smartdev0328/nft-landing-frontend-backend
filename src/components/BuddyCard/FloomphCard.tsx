...
import Egg from 'images/nfts/0Floomph.png';
    ...
    if (isVideoEnded) {
      return (
        <div className="w-full items-center flex text-center flex-col bg-white p-8">
          ...
          <div className=" mb-2 text-white rounded-full text-xs bg-primary-6000 border-0 p-10 py-2 cursor-pointer">
          Continue
          </div>
        </div>
      );
    ...
    return (
      <div className="w-full">
        <video autoPlay onEnded={() => setIsVideoEnded(true)}>
          <source type="video/mp4" src="../1.mp4"></source>
        </video>
      </div>
    );
  };
  ...
  return (
    <div
      ...
      <div className="relative flex-shrink-0 ">
        <div className="bg-gradient-to-r from-[#FFF9EB] to-[#FAE4AD] rounded-3xl">
          <Link to={'/nft-detail1'}>
            <NcImage
      ...
      <div className="p-4 py-5 space-y-3">
        ...
        <h2 className={`text-xl font-medium`}>Floomph</h2>
