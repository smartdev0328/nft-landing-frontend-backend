...
const CardNFT: FC<CardNFTProps> = ({ className = '', isLiked }) => {
  ...
  const renderContent = () => {
    const timerToken = window.setTimeout(() => setShowModal(false), 28000);

    return (
      <div className="w-full ">
        <video muted autoPlay>
          <source type="video/mp4" src="./nessie.mp4"></source>
        </video>
      </div>
    );
  };
  ...
  return (
    <div
      ...
      <div className="relative flex-shrink-0 ">
        <div className="bg-gradient-to-r from-[#CBECEC] to-[#B2B2F8] rounded-t-3xl">
          <Link to={'/nft-detail2'}>
            <NcImage
