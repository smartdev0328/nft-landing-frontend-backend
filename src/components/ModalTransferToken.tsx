...
const ModalTransferToken: FC<ModalTransferTokenProps> = ({ show, onCloseModalTransferToken }) => {
  ...
  const renderContent = () => {
    return (
      <form action="#">
        ...
        <span className="text-sm">You can transfer tokens from your address to another</span>
        <div className="mt-8 ">
