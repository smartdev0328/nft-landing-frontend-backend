...
const CardAuthorBox4: FC<CardAuthorBox4Props> = ({ className = '', following, authorIndex }) => {
  return (
    <div
        ...
        <div className="text-center relative flex items-center justify-center ">
          <div className="relative">
            ...
            <div className="absolute -top-7 left-1/2 -translate-x-1/2">
              <Avatar containerClassName="" sizeClass="w-12 h-12 text-2xl" radius="rounded-full" />
            </div>
          </div>
        </div>
        <div className="mt-2.5 flex items-start items-center justify-between">
          <div>
            ...
            <span className={`block mt-0.5 text-sm `}>
              ...
              <span className={`ml-1.5 text-neutral-500 dark:text-neutral-400`}>ETH</span>
            </span>
          </div>
          <FollowButton sizeClass="px-4 py-2 min-w-[84px]" isFollowing={following} />
        </div>
      </div>
