          ...
          <>
            <Popover.Button
              ...
              {!saleTypeStates.length ? (
                ...
                <span onClick={() => setSaleTypeStates([])}>{renderXClear()}</span>
              )}
            </Popover.Button>
            <Transition
              as={Fragment}
        ...
        {({ open, close }) => (
          <>
            <Popover.Button
              ...
              <span className="ml-2">
                {sortOrderStates
                  ? sortOrderRadios.filter((i) => i.id === sortOrderStates)[0].name
                  : 'Sort order'}
              </span>
              {!sortOrderStates.length ? (
                <ChevronDownIcon className="w-4 h-4 ml-3" />
          ...
          <>
            <Popover.Button
              ...
              {!fileTypesState.length ? (
                ...
                <span onClick={() => setfileTypesState([])}>{renderXClear()}</span>
              )}
            </Popover.Button>
            <Transition
              as={Fragment}
                  ...
                  <div className="flex-grow overflow-y-auto">
                    <div className="px-8 md:px-10 divide-y divide-neutral-200 dark:divide-neutral-800">
                      ...
                      <div className="py-7">
                        ...
                        <div className="mt-6 relative ">{renderMoreFilterItem(typeOfSales)}</div>
                      </div>
                      {/* --------- */}
                      {/* ---- */}
                      <div className="py-7">
                        <h3 className="text-xl font-medium">File Types</h3>
                        <div className="mt-6 relative ">{renderMoreFilterItem(fileTypes)}</div>
                      </div>
