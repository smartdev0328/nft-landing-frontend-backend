const nftabi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'category', type: 'uint256' }
    ],
    name: 'MintCategoryNFT',
    type: 'event'
  },
  {
    anonymous: false,
  ...
  },
  {
    ...
    inputs: [
      { indexed: false, internalType: 'address', name: 'owner', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'tokenid', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'categoryChosen', type: 'uint256' }
    ],
    name: 'SignalHatching',
    type: 'event'
  },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'bytes32', name: 'oldData', type: 'bytes32' }],
    name: 'UpdateMerkleRoot',
    type: 'event'
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'string', name: 'url', type: 'string' }],
    name: 'UpdateTokenURI',
    type: 'event'
  },
  {
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'category', type: 'uint256' }],
    name: 'getCategoryRemainingMints',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function'
  },
