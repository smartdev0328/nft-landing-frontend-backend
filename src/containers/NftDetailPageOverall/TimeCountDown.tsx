...
const TimeCountDown = () => {
  ...
  return (
    <div className="space-y-5">
      <div className="text-neutral-500 dark:text-neutral-400 flex space-x-2 ">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
        ...
        <span className="leading-none mt-1">
          {timeLeft.days + timeLeft.hours + timeLeft.minutes + timeLeft.seconds > 0 ? 'Starting sale in:' : 'Status:'}
        </span>
      </div>
      {
        timeLeft.days + timeLeft.hours + timeLeft.minutes + timeLeft.seconds > 0 ? <div className="flex space-x-5 sm:space-x-10">
          ...
          : <div className="relative text-center text-2xl text-green-500 font-bold">
            On Sale Now
            <span className="w-3 h-3">
              <span className="animate-ping absolute inline-flex w-3 h-3 rounded-full bg-sky-400"></span>
