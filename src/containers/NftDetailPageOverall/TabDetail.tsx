...
const TabDetail = () => {
  const TABS = ['History', 'Generations', 'Collections'];
            ...
            <div className="flex items-center">
              ...
              <span className="ml-4 text-neutral-500 dark:text-neutral-400 flex flex-col">
                <span className="flex items-center text-sm">
                  <span className="">Offered 2995 FYN for Floomph</span>
                  {/* <span className="">
  ...
  const renderTabItem = (item: string) => {
    switch (item) {
      case 'History':
        return renderTabHistory();

      case 'Generations':
        return renderTabGenerations();

      case 'Collections':
        return renderTabCollections();
